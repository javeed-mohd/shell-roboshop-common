...
AWS CLI: Configured on your workstation to manage Route53 records and EC2 instance states.

🛠️ How to Deploy
Clone the repository:

git clone https://github.com/javeed-mohd/shell-roboshop-common.git
